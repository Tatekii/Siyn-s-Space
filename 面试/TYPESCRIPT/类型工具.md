...
type _DeepRequiredArray<T> = Array<DeepRequired<NonUndefined<T[number]>>>
...
- `DeepReadonlyArray`
```typescript
type DeepReadonlyArray<T> = T extends ((args:...arg) => any) | Primitive ? T : T extends _DeepReadonlyArray<infer U> ? _DeepReadOnlyArray<U> : T extends _DeepReadonlyObject<infer U> ? _DeepReadonlyObject<U> : T
